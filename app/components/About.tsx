      ...
      <div className="max-w-[900px] gap-2 grid grid-cols-12 grid-rows-2 px-8">
        <Card className="col-span-12 sm:col-span-4 h-[300px]">
          <CardHeader className="absolute z-10 top-1 flex-col !items-start">
            <p className="text-tiny text-white uppercase font-bold pb-2">
              Professional Networking
            </p>
            <p className="text-white/60 font-light text-xs">
              Create profiles that serve as online resumes. Users can connect
              with colleagues, friends, and other professionals in their
              industry.
            </p>
          </CardHeader>
          <Image
        ...
        <Card className="col-span-12 sm:col-span-4 h-[300px]">
          <CardHeader className="absolute z-10 top-1 flex-col !items-start">
            ...
            <p className="text-white/60 font-light text-xs">
              Users can search for job listings, apply for positions, and
              companies can use it to find and recruit potential employees.
            </p>
          </CardHeader>
          <Image
            removeWrapper
