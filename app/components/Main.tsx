                ...
                <div className="mt-8">
                    <Section delay={0.5}>
                        ...
                        <p className="text-center px-8">
                            Our platform makes finding job listings easy. Simply
                            enter your search criteria and browse through a wide
                            range of available potitions
                        </p>
                    </Section>
                    <Section delay={0.7}>
                ...
                <div className="w-full h-screen flex bg-gradient-to-b dark:from-blue-900 dark:to-blue-950 from-blue-600 to-indigo-400">
                    <div className="flex flex-col align-middle justify-center ml-24 w-1/2 p-4">
                        ...
                        <p className="font-light py-4 text-center md:text-start">
                            Find you Dream Job with our comprehensive job
                            listings. We connect you with top employers in your
                            area
                        </p>
