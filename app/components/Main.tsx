...
const Main = ({ lang }: MainProps) => {
  let source;
  if (lang === "en" ? (source = en.main) : (source = am.main))
    return (
      <div className="">
        <div className="w-full h-screen flex bg-gradient-to-b from-blue-900 to-blue-950 ">
          <div className="w-full md:w-1/2 p-12 flex flex-col gap-6 mt-12">
            ...
            <Section delay={0.7}>
              <p className="mt-4 text-white">{source.description}</p>
            </Section>
            <Section delay={1.2}>
          ...
          <div className="w-1/2 hidden md:flex overflow-visible light">
          ...
          <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
                <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                  <p className="mt-2 text-lg/7 font-medium tracking-tight text-gray-950 max-lg:text-center">
                    {source.mobileFriendly.title}
                  </p>
                  <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                    {source.mobileFriendly.description}
                  </p>
                </div>
            ...
            <div className="relative max-lg:row-start-1">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
                <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                  <p className="mt-2 text-lg/7 font-medium tracking-tight text-gray-950 max-lg:text-center">
                    {source.performance.title}
                  </p>
                  <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                    {source.performance.description}{" "}
                  </p>
                </div>
            ...
            <div className="relative lg:row-span-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
                <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                  <p className="mt-2 text-lg/7 font-medium tracking-tight text-gray-950 max-lg:text-center">
                    {source.talkToRecruiters.title}
                  </p>
                  <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                    {source.talkToRecruiters.description}
                  </p>
                </div>
