...
import EditContent from "../../components/(profile)/EditContent";
...
import NewEducation from "../../components/(profile)/NewEducation";
import { getEducation } from "@/app/helpers/getEducation";
import NewExperience from "../../components/(profile)/NewExperience";
    ...
    <div className="w-screen h-[calc(100vh-5rem)] flex bg-[#F4F2EE]">
      <div className="w-1/3 h-full flex flex-col px-8 bg-white/75 m-2 rounded-md">
        ...
        <div className="w-full flex flex-col justify-center items-center mb-12">
          ...
          <h2 className="text-slate-800 line-clamp-24 my-2">{userInfo.bio}</h2>
        </div>
