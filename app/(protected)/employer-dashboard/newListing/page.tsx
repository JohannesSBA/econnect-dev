...
const NewJobListing = () => {
    ...
    const handleSubmit = async (e: FormEvent<HTMLElement>) => {
        ...
        const description = `${promotion}!sqaout!${screeningQuestions}`;
        e.preventDefault();
    ...
    const screenQ = [
        ...
        },
        {
            name: "Languages",
            question:
                "What languages are required for this job? Seperate them using commas (e.g. English, Amharic, French)",
            input: "checkbox",
            options: [""],
        },
        {
            name: "Experience",
            question: "How many years of experience do you have using?",
            input: "text",
            idealNumber: "number",
        },
        ...
        {
            name: "Location",
            question: "Are you comfortable relocation to the jobs location?",
            input: "checkbox",
            options: ["Yes", "No"],
        },
        {
                        ...
                        <div className="space-y-12">
                            <div className="border-b border-gray-900/10 pb-12">
                                ...
                                <p className="mt-1 text-sm leading-6 text-gray-600">
                                    You wil recieve an email notification when
                                    you recieve 10+ applications.
                                </p>
                                ...
                                <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    <div className="col-span-full">
                                        ...
                                        <p className="mt-3 text-sm leading-6 text-gray-600">
                                            What is the title for this job
                                            listing?
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="border-b border-gray-900/10 pb-12">
                                ...
                                {/* <QuestionSelector
                                    screenQ={screenQ}
                                    setScreeningQuestions={function (
                            ...
                            <div className="border-b border-gray-900/10 pb-12">
                                ...
                                <p className="mt-1 text-sm leading-6 text-gray-600">
                                    Promoite your job listing to get more views
                                    and potential applicants for you listing
                                </p>
            ...
            <div className="overflow-hidden bg-white shadow sm:rounded-lg w-60 h-fit">
                <div className="px-4 py-5 sm:p-6 flex flex-col h-fit gap-2">
                    ...
                    <p className="flex-wrap font-light text-left text-sm">
                        You will be informed of candidates who pass your
                        screening questions, and your job posting is sent to
                        those who meet your standards. Along with our AI tool,
                        we can fast track the application process for you!
                    </p>
                </div>
            </div>
