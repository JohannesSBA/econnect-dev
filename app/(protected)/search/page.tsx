...
import { Button, Link, Image, User } from "@nextui-org/react";
    ...
    <div className="w-screen h-screen flex flex-col items-center bg-white">
      <div className="flex flex-col items-center h-full w-full overflow-scroll scrollbar-webkit scrollbar-thin">
        ...
        <div className="flex w-full h-full p-4 gap-2 shadow-sm">
          <div className="w-1/3 h-full bg-red-400 p-2">
          ...
          <div className="w-1/3 h-full bg-blue-400 p-2">
          ...
          <div className="w-1/3 h-full bg-green-400 p-2">
