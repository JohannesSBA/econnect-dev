                                    ...
                                    <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                                        <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                                            <h1 className="text-pretty text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">
                                                ...
                                                get jobs in Ethiopia
                                            </h1>
                                            <p className="mt-8 text-pretty text-lg font-medium text-gray-500 sm:max-w-md sm:text-xl/8 lg:max-w-none">
                                                At E-Connect, we understand the
                                                unique challenges young
                                                professionals and professionals
                                                of all ages, face when entering
                                                the workforce. Navigating job
                                                opportunities can be
                                                overwhelming, especially when
                                                the process feels impersonal and
                                                exhausting. That is why we
                                                created E-Connect—to empower you
                                                to take control of your career
                                                journey with confidence and
                                                ease. Our platform allows you to
                                                apply for jobs from anywhere,
                                                eliminating the need for tedious
                                                resume drops and giving you the
                                                flexibility to pursue
                                                opportunities on your terms. We
                                                have dedicated ourselves to
                                                building a service that not only
                                                simplifies the job search
                                                process but also supports you in
                                                taking that crucial next step
                                                towards a bright future. We
                                                believe that everyone deserves
                                                the chance to showcase their
                                                potential, and we are here to
                                                help you make meaningful
                                ...
                                <div className="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
                                    <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
                                        <p className="text-xl leading-8 text-gray-600">
                                            To empower individuals by providing
                                            a user-friendly online portal for
                                            accessing job listings, enabling
                                            businesses to find qualified
                                            candidates, fostering career growth,
                                            and reducing unemployment in
                                            Ethiopia.
                                        </p>
                        ...
                        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
                            <div className="mx-auto max-w-2xl lg:mx-0">
                                ...
                                <p className="mt-6 text-lg leading-8 text-gray-600">
                                    E-Connect bridges the gap between job
                                    seekers and businesses, offering a
                                    comprehensive job search experience for
                                    individuals while providing businesses with
                                    access to a pool of qualified candidates,
                                    thus addressing unemployment challenges in
                                    Ethiopia.
                                </p>
                            </div>
